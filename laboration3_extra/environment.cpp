...
namespace camelot {
    ...
    Environment::~Environment() {
      ...
      //for (auto keyvalue : exits) { delete keyvalue.second; }
...
// add_exit() ...............................................................
    ...
    bool Environment::add_exit(std::string name, std::shared_ptr<Exit> exit)
    {
        std::pair<std::string, std::shared_ptr<Exit>> p(name, exit);
        //std::pair<std::string, Exit *> p(name, exit);
        std::pair<std::map<std::string,std::shared_ptr<Exit>>::iterator, bool> ret = exits.insert(p);
...
// get_exit() ...............................................................
     ...
     */
    std::shared_ptr<Exit> Environment::get_exit(std::string name) const
    //Exit * Environment::get_exit(std::string name) const 
    {
        std::map<std::string,std::shared_ptr<Exit>>::const_iterator it = exits.find(name);
...
// get_exit_names() ..........................................................
    ...
    {
        std::map<std::string, std::shared_ptr<Exit>>::const_iterator it;
...
// pick_up() .................................................................
     ...
     * otherwise false.
     */
    bool Environment::pick_up(std::shared_ptr<Object> obj) 
    //bool Environment::pick_up(Object *obj) 
    {
        ...
        for (; it != objects->end(); ++it) {
            ...
            if ((**it) == *obj) {
                ...
                //objects->erase(*it);
                //objects->erase(it); // XXX XXX XXX XXX XXX Doesn't work with shared_ptr<>
                                     //erasing from STL containers invalidates 
                                     //any iterator associated with them
                std::cout << "\t current room objects are: " << objects->size() << std::endl;
                return true;
...
// drop() ...................................................................
     ...
     */ 
    void Environment::drop(std::shared_ptr<Object> obj) {
...
// saveEnv() ...................................................................
    ...
    void Environment::saveEnv(std::fstream &ofs) {
        ...
        ofs << ":";
        first = true;
        for (std::map<std::string, std::shared_ptr<Exit>>::iterator it = exits.begin(); 
...
// get_objects() ....................................................................
    ...
    std::vector<std::shared_ptr<Object >> Environment::get_objects() {
    //std::vector<Object *> Environment::get_objects() {
        //return objects;
        //return std::shared_ptr<Object> objects;
        return *objects;
    }
