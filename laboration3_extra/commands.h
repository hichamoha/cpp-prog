...
namespace camelot {
    ...
    class Commands {
        ...
        public:
            ...
            //static void saveGame(std::istringstream iss);  // XXX
        ...
        private:
            ...
            static std::shared_ptr<Object> get_object(std::shared_ptr<std::vector<std::shared_ptr<Object> >> , int);
            //static std::shared_ptr<Object> get_object(std::vector<std::shared_ptr<Object >> * , int);
