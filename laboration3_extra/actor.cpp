...
namespace camelot 
  ...
  // constructor ............................................................
    Actor::Actor() : id(instances) // Constructor initializer list
    {
        ...
        //std::shared_ptr<Bag> bag = std::dynamic_pointer_cast<Bag> (container); //XXX XXX XXX XXX XXX
        container = std::make_shared<Bag>();
  ...
  // destructor --------------------------------------------------------------
    ...
    {   /*
        ...
        */
        ...
        for (it = container->get_items()->begin(); 
             it != container->get_items()->end(); ++it) 
        ...
        //     it != container->get_objects()->end(); ++it) 
        {
            ...
            current_room->drop(*it);
        			...
        			container->get_items()->clear(); //TODO
  ...
  // pick_up() .................................................................
    //bool Actor::pick_up(Object *obj){
    bool Actor::pick_up(std::shared_ptr<Object> obj){
        //return container->add(obj);
        return container->add(*obj);
    }

  // drop() ..............................................................
    bool Actor::drop(std::shared_ptr<Object> obj) {
    //bool Actor::drop(Object *obj) {
  ...
  // go() -----------------------------------------------------------------
    ...
    void Actor::go(std::string exit_name) {
        ...
        std::shared_ptr<Exit> exit = current_room->get_exit(exit_name);
  ...
  // loadAct() ----------------------------------------------------------------
    ...
    Actor * Actor::loadAct(const std::string line, 
                           ...
                           const std::map<std::string, std::shared_ptr<Object>> & objs) 
    //Actor * Actor::loadAct(const std::string line, 
    //                       const std::map<std::string, Environment *> & envs,
    //                       const std::map<std::string, Object *> & objs) 
    {
        ...
        std::shared_ptr<Object> cont_obj = objs.find(container_id)->second;
        ...
        if (std::shared_ptr<Container> cont = std::dynamic_pointer_cast<Container>(cont_obj)) { 
