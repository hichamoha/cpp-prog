...
int main()
{
    ...
    //==============Testing add_month & add_year ===============================

    std::cout << std::endl << "Testing add_month thoroughly..." << std::endl;
    ...
    std::cout << std::endl << "All tests were successful !!!!." 
              << std::endl << std::endl;
